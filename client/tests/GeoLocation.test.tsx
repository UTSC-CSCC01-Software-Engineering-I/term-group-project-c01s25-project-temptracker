...
describe("getUserLocation", () => {
  ...
  test("resolves with default Toronto coords when permission is denied or error occurs", async () => {
  ...
  test("resolves with default Toronto coords when geolocation is not supported", async () => {
    // @ts-ignore
