import UploadTemperatureForm from "./UploadSingleTempForm";
import UploadTemperatureCSVForm from "./UploadTempCSV";
      ...
      <div className="max-w-2xl lg:max-w-[900px] mx-auto flex flex-col items-center space-y-6">
        <div className="text-center">
          ...
          <p className="text-muted px-2">
            Contribute to our water temperature database by first signing in and
            then submitting your data below.
          </p>
        </div>
